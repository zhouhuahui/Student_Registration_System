...
public class ConflictCourseGUI extends JDialog implements ActionListener{//显示冲突课程并可进行进一步的操作
	private JButton button1,button2,button3;//删除冲突课程，撤销选课操作
	...
	public ConflictCourseGUI(JTable jtable1,JTable jtable2,Socket socket,String[] conflicttable,ShowCourseGUI showGUI0) {
		...
		setBounds( (width-900)/2, (height-400)/2+200 ,900,400);//设置窗体应该出现的位置
		setLayout(null);
        ...
        button1.setBounds(100,290,200,30);
        this.add(button1);
        button1.addActionListener(this);
        
		button2=new JButton("取消(您当前所有选择将全部丢失)");
        button2.setBounds(500,290,300,30);
        this.add(button2);
        button2.addActionListener(this);
        
        button3=new JButton("撤销当前选择的课程");
        button3.setBounds(300,290,200,30);
        this.add(button3);
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if(e.getSource()==button3)//撤销操作，显示消息，关闭当前界面
		{

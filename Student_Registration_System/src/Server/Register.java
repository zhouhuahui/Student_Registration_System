...
public class Register {
	...
	public void merge_course(String sid,String pos) {
		...
		try {
			...
			if(l5!=null) {//若第一个备选课不为空
				...
				if(isl5=true) {
					if(pos.contentEquals("lesson1")) {
						sql= "update course_selection set lesson1=?,lesson5=null where sid=?";
					}else if(pos.contentEquals("lesson2")) {
						sql= "update course_selection set lesson2=?,lesson5=null where sid=?";
					}
					else if(pos.contentEquals("lesson3")) {
						sql= "update course_selection set lesson3=?,lesson5=null where sid=?";
					}
					else if(pos.contentEquals("lesson4")) {
			...
			if(l6!=null) {//若第2个备选课不为空
				...
				if(isl6=true) {
					if(pos.contentEquals("lesson1")) {
						sql= "update course_selection set lesson1=?,lesson6=null where sid=?";
					}else if(pos.contentEquals("lesson2")) {
						sql= "update course_selection set lesson2=?,lesson6=null where sid=?";
					}
					else if(pos.contentEquals("lesson3")) {
						sql= "update course_selection set lesson3=?,lesson6=null where sid=?";
					}
					else if(pos.contentEquals("lesson4")) {
    ...
    public void searchID(String sql) 
    {
